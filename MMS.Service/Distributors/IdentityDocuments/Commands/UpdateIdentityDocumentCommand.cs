...
{
    [CommandValidator(typeof(UpdateIdentityDocumentCommandValidator))]
    public class UpdateIdentityDocumentCommand : BaseCommand<UpdateIdentityDocumentCommand>
    {
    ...
    public class UpdateIdentityDocumentCommandValidator : CommandValidator<UpdateIdentityDocumentCommand>
    {
